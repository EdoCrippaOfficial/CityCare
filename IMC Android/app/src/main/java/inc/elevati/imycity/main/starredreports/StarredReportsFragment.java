...
/** This fragment shows all reports starred by current user retrieved from the database */
public class StarredReportsFragment extends Fragment implements MainContracts.ReportListView, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void showReportDialog(Report report) {
        ReportDialog dialog = ReportDialog.newInstance(report, PAGE_STARRED);

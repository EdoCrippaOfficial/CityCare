...
/** This fragment shows all reports created by current user retrieved from the database */
public class MyReportsFragment extends Fragment implements MainContracts.ReportListView, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void showReportDialog(Report report) {
        ReportDialog dialog = ReportDialog.newInstance(report, PAGE_MY);

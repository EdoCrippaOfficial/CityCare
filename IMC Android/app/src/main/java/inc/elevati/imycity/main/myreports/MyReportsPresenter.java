...
/** Presenter associated to {@link MyReportsFragment} */
public class MyReportsPresenter implements MainContracts.ReportListPresenter {
     ...
     * {@link MyReportsPresenter#onLoadReportsTaskComplete(QuerySnapshot)} has to be executed */
    private QuerySnapshot results;

    /** This flag is set when {@link MyReportsPresenter#onUpdateTaskComplete()}
    ...
    public void loadReports() {
        ...
        reader.readMyReports(FirebaseAuthHelper.getUserId());
    }

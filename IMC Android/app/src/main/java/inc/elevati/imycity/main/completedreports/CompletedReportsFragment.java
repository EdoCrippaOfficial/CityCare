...
public class CompletedReportsFragment extends Fragment implements MainContracts.ReportListView, SwipeRefreshLayout.OnRefreshListener {
     ...
     */
    public static CompletedReportsFragment newInstance() {

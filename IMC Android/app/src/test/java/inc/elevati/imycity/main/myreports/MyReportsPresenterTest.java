...
@PrepareForTest({MyReportsPresenter.class, FirebaseAuthHelper.class})
public class MyReportsPresenterTest {
    ...
    private MyReportsPresenter presenter;

    @Before
    public void setUp() throws Exception {
        view = mock(MyReportsFragment.class);
        presenter = new MyReportsPresenter();
    ...
    public void loadReportsTest() {
        ...
        verify(firestoreHelper).readMyReports(uid);
    }
